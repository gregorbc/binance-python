...
class TestCandlePatterns(unittest.TestCase):
    ...
    def test_bullish_engulfing(self):
        ...
        self.assertTrue(self.patterns.is_bullish_engulfing(curr_candle, prev_candle))

        # Negative case: previous candle is not bearish
        prev_candle = {'open': 100, 'close': 105, 'high': 106, 'low': 99}
        self.assertFalse(self.patterns.is_bullish_engulfing(curr_candle, prev_candle))
    ...
    def test_bearish_engulfing(self):
        ...
        self.assertTrue(self.patterns.is_bearish_engulfing(curr_candle, prev_candle))

        # Negative case: previous candle is not bullish
        prev_candle = {'open': 105, 'close': 100, 'high': 106, 'low': 99}
        self.assertFalse(self.patterns.is_bearish_engulfing(curr_candle, prev_candle))
